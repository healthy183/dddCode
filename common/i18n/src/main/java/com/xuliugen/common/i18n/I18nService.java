...
import com.xuliugen.common.i18n.exception.NoSuchMessageException;
...
public interface I18nService {
     ...
     * found.
     * @param code         the code to lookup up, such as 'calculator.noRateSet'. Users
     ...
     * @param errorMessage String to return if the lookup fails
